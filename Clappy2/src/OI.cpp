...
#include "Commands/ToggleGearArms.h"
...
OI::OI() {
    ...
    controlSwitchButton.reset(new JoystickButton(joystick1.get(), 1));
    controlSwitchButton->WhenPressed(new ToggleRobotDirection());

    toggleGearArmsButton.reset(new JoystickButton(joystick2.get(), 1));
    toggleGearArmsButton->WhenPressed(new ToggleGearArms());

    //SmartDashboard Buttons
    //SmartDashboard::PutData("DriveTeleop", new DriveTeleop());
    //SmartDashboard::PutData("SwitchRobotControls", new SwitchRobotControls());
